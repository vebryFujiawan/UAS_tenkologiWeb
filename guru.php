...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <li class="nav-item">
            <a class="nav-link active text-white bg-secondary" href="guru.php"><i class="fas fa-chalkboard-teacher mr-3"></i>Daftar Guru</a><hr class="bg-info">
        </li>
         <li class="nav-item">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-user-graduate mr-3"></i>DAFTAR GURU</h3><hr>
            <a href="tambahguru.php" class="btn btn-primary"><i class="fas fa-plus-square mr-2"></i>TAMBAH DATA GURU</a>
            ...
            <tr>
              ...
              <td class="text-center">
                    <a href="tambahguru.php?hal=edit&id=<?=$data['id_guru']?>" class="btn btn-primary btn-sm shadow-sm">Detail</a>
                    <a href="tambahguru.php?hal=hapus&id=<?=$data['id_guru']?>" 
                    <a href="tambahguru.php?hal=edit&id=<?=$data['id_guru']?>"><i class="fas fa-edit bg-warning p-2 text-white rounded" data-toggle="tooltip" title="Edit"></i></a>
                    <a href="tambahguru.php?hal=hapus&id=<?=$data['id_guru']?>" 
