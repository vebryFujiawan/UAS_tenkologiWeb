...
$server = "localhost";
    ...
    if(isset($_POST['bsimpan'])){
        $simpan = mysqli_query($koneksi, "INSERT INTO siswa (NISN, Nama, Alamat, Kelas)
                                VALUES ('$_POST[tnisn]',
                                '$_POST[tnama]',
                                '$_POST[talamat]',
                                '$_POST[tkelas]')
...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <li class="nav-item">
            <a class="nav-link text-white bg-secondary" href="siswa1.php"><i class="fas fa-user-graduate mr-3"></i>Daftar Siswa</a><hr class="bg-info">
        </li>
        <li class="nav-item">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-plus-square mr-2"></i>TAMBAH DATA SISWA</h3><hr>
            <div class="card mt-3">
            ...
            <div class="card-body">
                <form method="post" action="">
                    <div class="form-group">
                        <label>NISN</label>
                        <input type="text" name="tnisn" value="<?=@$vnisn?>" class="form-control" placeholder="Masukan NISN disini!!" required>
                    </div>
                    <div class="form-group">
                        <label>Nama</label>
                    ...
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="talamat" class="form-control" placeholder="Masukan Alamat disini!!"><?=@$valamat?></textarea>
                    </div>
                    <div class="form-group">
                        <label>Kelas</label>
